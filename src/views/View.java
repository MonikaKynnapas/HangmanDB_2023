...
public class View extends JFrame {
    ...
    private void setupFrame() {
        ...
        this.setPreferredSize(new Dimension(520, 400)); // Windows size
    }

    private void setupPanels() {
        panelTop = new PanelTop(model); // Create panel top
        panelBottom = new PanelBottom(); // Create panel bottom

        this.add(panelTop, BorderLayout.NORTH); // Add panel top on JFrame
        this.add(panelBottom, BorderLayout.CENTER); // Add panel top on JFrame
    }
    ...
    public void registerItemStateChanged(ItemListener e) {
        panelTop.getCmbCategory().addItemListener(e);
    }
