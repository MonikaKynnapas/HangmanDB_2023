...
public class MyTable {
    ...
    private void createTable() {
        JScrollPane jsp = new JScrollPane(table); // Scroll pane
        ...
        table.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2) {
                    ...
                    int result = JOptionPane.showConfirmDialog(view, "Shall we delete the record?");
        ...
        // last column is hidden https://stackhowto.com/how-to-hide-a-column-in-jtable/
